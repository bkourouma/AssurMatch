...
const HREF = "/countries/[countryCode]/terms" as const;
const GLOBAL_HREF = "/terms" as const;
...
export default async function CountryTermsPage({ params }: { params: Promise<PageParams> }) {
  const { locale: rawLocale, countryCode } = await params;
