...
const HREF = "/countries/[countryCode]/legal-notice" as const;
const GLOBAL_HREF = "/legal-notice" as const;
...
export default async function CountryLegalNoticePage({ params }: { params: Promise<PageParams> }) {
  const { locale: rawLocale, countryCode } = await params;
