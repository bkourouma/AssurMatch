...
const HREF = "/countries/[countryCode]/cookies" as const;
const GLOBAL_HREF = "/cookies" as const;
...
export default async function CountryCookiesPage({ params }: { params: Promise<PageParams> }) {
  const { locale: rawLocale, countryCode } = await params;
